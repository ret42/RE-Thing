...
- ### Deobfuscator / Decompiler / Unpacker etc...
  ...
  - [dnlib](https://github.com/0xd4d/dnlib) - Reads and writes .NET assemblies and modules **LIBRARY FOR C#**
  ...
  - UPX: For unpack files, type `upx -d YOURFILE`
...
Fix assembly pe header and metadata errors
  ...
  - [PointMutationRemover](https://github.com/DevT02/PointMutationRemover) - Does exactly what the title says, removes Point Mutations. Only supported with 2D points at the moment.
  ...
  - [SimpleMathCleaner](https://github.com/Mageland29/SimpleMathCleaner) - Simple Math Cleaner with invoke method for generic use
  ...
  - [Universal-Math-Fixer](https://github.com/Alxs009/Universal-Math-Fixer) - This calculator load all methods from mscorlib.dll and checks equivalence with the method from the instruction
